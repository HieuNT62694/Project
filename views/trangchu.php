    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
  	  ...
  	  <div class="carousel-inner" role="listbox">
  	    <div class="item active">
  	      <img src="public/news_theme/images/banner.jpg" alt="Chania">
  	    ...
  	    <div class="item">
  	      <img src="public/news_theme/images/banner.jpg" alt="Flower">
  	      <div class="carousel-caption">
  	        <h3>Flowers</h3>
  	...
  	<div class="banner-bottom">
  		<div class="container">
  			<div class="move-text">
  				...
  				<div class="clearfix"></div>
  				<script type="text/javascript" src="public/news_theme/js/jquery.marquee.js"></script>
  				<script>
  				...
  				<div class="video-grids">
  					<div class="col-md-8 video-grids-left">
  						<div class="video-grids-left1">
  							<img src="public/news_theme/images/9.jpg" alt=" " class="img-responsive" />
  						...
  						<div class="video-grids-left2">
  							<div class="course_demo1">
  								<ul id="flexiselDemo1">
  									<li>
  										<div class="item">
  											<img src="public/news_theme/images/10.jpg" alt=" " class="img-responsive" />
  									...
  									<li>
  										<div class="item">
  											<img src="public/news_theme/images/11.jpg" alt=" " class="img-responsive" />
  									...
  									<li>
  										<div class="item">
  											<img src="public/news_theme/images/12.jpg" alt=" " class="img-responsive" />
  							...
  							<!-- requried-jsfiles-for owl -->
  							 ...
  							 <script type="text/javascript" src="public/news_theme/js/jquery.flexisel.js"></script>
  						</div>
  					</div>
  					...
  					<div class="col-md-4 video-grids-right">
  						<div class="sap_tabs">
  							<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
  								...
  								<script src="public/news_theme/js/easyResponsiveTabs.js" type="text/javascript"></script>
  								<script type="text/javascript">
  						...
  						<div class="col-md-3 video-bottom-grid">
  							<div class="video-bottom-grid1">
  								<div class="video-bottom-grid1-before">
  									<img src="public/news_theme/images/13.jpg" alt=" " class="img-responsive" />
  						...
  						<div class="col-md-3 video-bottom-grid">
  							<div class="video-bottom-grid1">
  								<div class="video-bottom-grid1-before before1">
  									<img src="public/news_theme/images/14.jpg" alt=" " class="img-responsive" />
  									<div class="video-bottom-grid1-pos">
  						...
  						<div class="col-md-3 video-bottom-grid">
  							<div class="video-bottom-grid1">
  								<div class="video-bottom-grid1-before before2">
  									<img src="public/news_theme/images/15.jpg" alt=" " class="img-responsive" />
  									<div class="video-bottom-grid1-pos">
  						...
  						<div class="col-md-3 video-bottom-grid">
  							<div class="video-bottom-grid1">
  								<div class="video-bottom-grid1-before before3">
  									<img src="public/news_theme/images/16.jpg" alt=" " class="img-responsive" />
  									<div class="video-bottom-grid1-pos">
  										<p>Lorem ipsum dolor sit amet adipiscing. </p>
  									</div>
  								</div>
  						...
  						<div class="col-md-3 video-bottom-grid">
  							<div class="video-bottom-grid1">
  								<div class="video-bottom-grid1-before before7">
  									<img src="public/news_theme/images/17.jpg" alt=" " class="img-responsive" />
  									<div class="video-bottom-grid1-pos">
  										<p>Lorem ipsum dolor sit amet adipiscing. </p>
  									</div>
  								</div>
